"""
File: crime_clustering_model.py

Description: Analyzes Chicago crime at the community area level from
2008–2012. Uses KMeans clustering to group community areas by
crime patterns, then applies logistic regression to predict
crime level using socioeconomic census indicators.
"""
...
FILE_1 = 'data/Crimes_-_2001_to_Present.csv'
FILE_2 = 'data/Census_Data_-_Selected_socioeconomic_indicators_in_Chicago,_2008_–_2012.csv'
...
def KMeans_clustering(community_data):
    ...
    # Sorted the centroids data by the crime count and determine the crime level
    ...
    # map each cluster label to its corresponding crime level
